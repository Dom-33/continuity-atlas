...
import hanumantSaxena from "./hanumant-saxena-maha-ram-singh.json";
import swarnlataMishra from "./swarnlata-mishra-biya-pathak.json";
...
export const validatedCases: ValidatedCaseRecord[] = [
  ...
  hanumantSaxena as ValidatedCaseRecord,
  swarnlataMishra as ValidatedCaseRecord,
